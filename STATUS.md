...
- 🔶 **MAR-103 (To Do)** — Kong `allowed_origins` hardcode localhost ใน `kong.tmpl.yml` → ทำเป็น env-driven `ALLOWED_ORIGINS` ใน `.env` (debt จาก live setup 2026-07-06, งานโค้ดล้วน ทำได้เลย)
